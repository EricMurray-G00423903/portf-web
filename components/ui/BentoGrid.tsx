  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(68,1,93,1) 100%)",
      }}
    >
      <div className={`${id === 6} && 'flex justify-center h-full `}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 transi duration-200 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
